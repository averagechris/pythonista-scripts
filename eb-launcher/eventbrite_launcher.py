...
SHORTCUTS = [
{'title': 'Search Admin', 'url': 'pythonista3://eventbrite_nav?action=run&args=admin%20eventbrite', 'color': '#ff8e13'},
{'title': 'Order Lookup', 'url': 'pythonista3://eventbrite_nav?action=run&args=order_lookup%20eventbrite', 'color': '#ff8e13'},
{'title': 'Edit Page', 'url': 'pythonista3://eventbrite_nav?action=run&args=edit%20eventbrite', 'color': '#ff8e13'},
{'title': 'Search Admin', 'url': 'pythonista3://eventbrite_nav?action=run&args=admin%20evbqa', 'color': '#146b79'},
{'title': 'Order Lookup', 'url': 'pythonista3://eventbrite_nav?action=run&args=order_lookup%20evbqa', 'color': '#146b79'},
{'title': 'Edit Page', 'url': 'pythonista3://eventbrite_nav?action=run&args=edit%20evbqa', 'color': '#146b79'},
{'title': 'tbd', 'url': 'pythonista3://eventbrite_nav?action=run&args=admin%20eventbrite', 'color': '#ff8e13'},
{'title': 'tbd', 'url': 'pythonista3://eventbrite_nav?action=run&args=admin%20eventbrite', 'color': '#ff8e13'},
{'title': 'tbd', 'url': 'pythonista3://eventbrite_nav?action=run&args=admin%20eventbrite', 'color': '#ff8e13'}
]
